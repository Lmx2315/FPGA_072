// altera_jesd204_altera_jesd204.v
...
`timescale 1 ps / 1 ps
module altera_jesd204_altera_jesd204 #(
		...
		parameter RECONFIG_SHARED          = 1,
		parameter RECONFIG_ADDRESS_WIDTH   = 7
	) (
	...
	generate
		...
		begin
			...
			instantiated_with_wrong_parameters_error_see_comment_above
					reconfig_shared_check ( .error(1'b1) );
		end
		if (RECONFIG_ADDRESS_WIDTH != 7)
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
	...
	altera_jesd204_altera_jesd204_inst_phy #(
		.DEVICE_FAMILY            ("Arria V"),
		.L                        (2),
