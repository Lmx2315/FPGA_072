...
//altiobuf_out CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Arria V" ENABLE_BUS_HOLD="FALSE" LEFT_SHIFT_SERIES_TERMINATION_CONTROL="FALSE" NUMBER_OF_CHANNELS=2 OPEN_DRAIN_OUTPUT="FALSE" PSEUDO_DIFFERENTIAL_MODE="FALSE" USE_DIFFERENTIAL_MODE="FALSE" USE_OE="FALSE" USE_TERMINATION_CONTROL="FALSE" datain dataout
...
//synthesis_resources = arriav_io_obuf 2 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  bufout2_iobuf_out_phs
	( 
	datain,
	dataout) ;
	input   [1:0]  datain;
	...
	assign
		...
		oe_w = {2{1'b1}};
endmodule //bufout2_iobuf_out_phs
//VALID FILE
...
module bufout2 (
	...
	bufout2_iobuf_out_phs	bufout2_iobuf_out_phs_component (
				.datain (datain),
				.dataout (sub_wire0));
