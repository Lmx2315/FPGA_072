//altclkctrl CBX_SINGLE_OUTPUT_FILE="ON" CLOCK_TYPE="Global Clock" DEVICE_FAMILY="Arria V" USE_GLITCH_FREE_SWITCH_OVER_IMPLEMENTATION="OFF" ena inclk outclk
...
`endif
	...
	assign
		clkselect = {2{1'b0}},
		outclk = wire_sd1_outclk;
endmodule //mypll_altclkctrl_0_sub
...
module  mypll_altclkctrl_0  (
    ...
    mypll_altclkctrl_0_sub  mypll_altclkctrl_0_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
