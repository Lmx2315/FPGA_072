...
# ----------------------------------------
# If nco_test is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 625 win32 2019.05.07.11:13:05
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/nco_test_nco_ii_0_sin.hex ./
  file copy -force $QSYS_SIMDIR/submodules/nco_test_nco_ii_0_cos.hex ./
}
...
alias com {
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nco_test_nco_ii_0.v"       -work nco_ii_0
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nco_test.v"                                         
}
