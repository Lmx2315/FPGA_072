...
//altiobuf_out CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Arria V" ENABLE_BUS_HOLD="FALSE" LEFT_SHIFT_SERIES_TERMINATION_CONTROL="FALSE" NUMBER_OF_CHANNELS=5 OPEN_DRAIN_OUTPUT="FALSE" PSEUDO_DIFFERENTIAL_MODE="FALSE" USE_DIFFERENTIAL_MODE="FALSE" USE_OE="FALSE" USE_TERMINATION_CONTROL="FALSE" datain dataout
...
//synthesis_resources = arriav_io_obuf 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  bufout5_iobuf_out_shs
	( 
	datain,
	dataout) ;
	input   [4:0]  datain;
	...
	assign
		...
		oe_w = {5{1'b1}};
endmodule //bufout5_iobuf_out_shs
//VALID FILE
...
module bufout5 (
	...
	bufout5_iobuf_out_shs	bufout5_iobuf_out_shs_component (
				.datain (datain),
				.dataout (sub_wire0));
