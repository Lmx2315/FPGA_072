...
//altiobuf_out CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Arria V" ENABLE_BUS_HOLD="FALSE" LEFT_SHIFT_SERIES_TERMINATION_CONTROL="FALSE" NUMBER_OF_CHANNELS=4 OPEN_DRAIN_OUTPUT="FALSE" PSEUDO_DIFFERENTIAL_MODE="FALSE" USE_DIFFERENTIAL_MODE="FALSE" USE_OE="FALSE" USE_TERMINATION_CONTROL="FALSE" datain dataout
...
//synthesis_resources = arriav_io_obuf 4 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  bufout4_iobuf_out_rhs
	( 
	datain,
	dataout) ;
	input   [3:0]  datain;
	...
	assign
		...
		oe_w = {4{1'b1}};
endmodule //bufout4_iobuf_out_rhs
//VALID FILE
...
module bufout4 (
	...
	bufout4_iobuf_out_rhs	bufout4_iobuf_out_rhs_component (
				.datain (datain),
				.dataout (sub_wire0));
