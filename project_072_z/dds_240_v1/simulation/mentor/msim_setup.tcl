...
# ----------------------------------------
# If dds_240_v1 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.0 595 win32 2018.10.05.15:59:18
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/dds_240_v1_nco_ii_0_sin.hex ./
  file copy -force $QSYS_SIMDIR/submodules/dds_240_v1_nco_ii_0_cos.hex ./
}
...
alias com {
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/asj_gal.v"          -work nco_ii_0
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dds_240_v1_nco_ii_0.v"     -work nco_ii_0
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dds_240_v1.v"                                       
}
