...
//altiobuf_in CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Arria V" ENABLE_BUS_HOLD="FALSE" NUMBER_OF_CHANNELS=6 USE_DIFFERENTIAL_MODE="FALSE" USE_DYNAMIC_TERMINATION_CONTROL="FALSE" datain dataout
...
//synthesis_resources = arriav_io_ibuf 6 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  bufi6_iobuf_in_6qh
	( 
	datain,
	dataout) ;
	input   [5:0]  datain;
...
module bufi6 (
	...
	bufi6_iobuf_in_6qh	bufi6_iobuf_in_6qh_component (
				.datain (datain),
				.dataout (sub_wire0));
