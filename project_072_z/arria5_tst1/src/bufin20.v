...
//altiobuf_in CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Arria V" ENABLE_BUS_HOLD="FALSE" NUMBER_OF_CHANNELS=20 USE_DIFFERENTIAL_MODE="FALSE" USE_DYNAMIC_TERMINATION_CONTROL="FALSE" datain dataout
...
//synthesis_resources = arriav_io_ibuf 20 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  bufin20_iobuf_in_irh
	( 
	datain,
	dataout) ;
	input   [19:0]  datain;
	...
	wire  [19:0]   wire_ibufa_i;
	wire  [19:0]   wire_ibufa_o;
...
endmodule //bufin20_iobuf_in_irh
//VALID FILE
...
module bufin20 (
	...
	wire [19:0] sub_wire0;
	wire [19:0] dataout = sub_wire0[19:0];

	bufin20_iobuf_in_irh	bufin20_iobuf_in_irh_component (
				.datain (datain),
				.dataout (sub_wire0));
