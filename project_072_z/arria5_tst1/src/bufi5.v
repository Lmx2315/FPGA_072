...
//altiobuf_in CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Arria V" ENABLE_BUS_HOLD="FALSE" NUMBER_OF_CHANNELS=5 USE_DIFFERENTIAL_MODE="FALSE" USE_DYNAMIC_TERMINATION_CONTROL="FALSE" datain dataout
...
//synthesis_resources = arriav_io_ibuf 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  bufi5_iobuf_in_5qh
	( 
	datain,
	dataout) ;
	input   [4:0]  datain;
...
module bufi5 (
	...
	bufi5_iobuf_in_5qh	bufi5_iobuf_in_5qh_component (
				.datain (datain),
				.dataout (sub_wire0));
