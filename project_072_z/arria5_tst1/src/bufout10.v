...
//altiobuf_out CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Arria V" ENABLE_BUS_HOLD="FALSE" LEFT_SHIFT_SERIES_TERMINATION_CONTROL="FALSE" NUMBER_OF_CHANNELS=10 OPEN_DRAIN_OUTPUT="FALSE" PSEUDO_DIFFERENTIAL_MODE="FALSE" USE_DIFFERENTIAL_MODE="FALSE" USE_OE="FALSE" USE_TERMINATION_CONTROL="FALSE" datain dataout
...
//synthesis_resources = arriav_io_obuf 10 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  bufout10_iobuf_out_8js
	( 
	datain,
	dataout) ;
	input   [9:0]  datain;
	...
	wire  [9:0]   wire_obufa_i;
	wire  [9:0]   wire_obufa_o;
	wire  [9:0]   wire_obufa_oe;
	wire  [9:0]  oe_w;
	...
	assign
		...
		oe_w = {10{1'b1}};
endmodule //bufout10_iobuf_out_8js
//VALID FILE
...
module bufout10 (
	...
	wire [9:0] sub_wire0;
	wire [9:0] dataout = sub_wire0[9:0];

	bufout10_iobuf_out_8js	bufout10_iobuf_out_8js_component (
				.datain (datain),
				.dataout (sub_wire0));
