...
//altiobuf_out CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Arria V" ENABLE_BUS_HOLD="FALSE" LEFT_SHIFT_SERIES_TERMINATION_CONTROL="FALSE" NUMBER_OF_CHANNELS=3 OPEN_DRAIN_OUTPUT="FALSE" PSEUDO_DIFFERENTIAL_MODE="FALSE" USE_DIFFERENTIAL_MODE="FALSE" USE_OE="FALSE" USE_TERMINATION_CONTROL="FALSE" datain dataout
...
//synthesis_resources = arriav_io_obuf 3 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  bufout3_iobuf_out_qhs
	( 
	datain,
	dataout) ;
	input   [2:0]  datain;
	...
	wire  [2:0]   wire_obufa_i;
	wire  [2:0]   wire_obufa_o;
	wire  [2:0]   wire_obufa_oe;
	wire  [2:0]  oe_w;
	...
	assign
		...
		oe_w = {3{1'b1}};
endmodule //bufout3_iobuf_out_qhs
//VALID FILE
...
module bufout3 (
	...
	bufout3_iobuf_out_qhs	bufout3_iobuf_out_qhs_component (
				.datain (datain),
				.dataout (sub_wire0));
